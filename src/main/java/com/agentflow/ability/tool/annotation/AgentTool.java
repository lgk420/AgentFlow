 ...
 * {@link com.agentflow.ability.tool.ToolDescriptor} 注册进注册中心——方法签名自动推断参数 JSON Schema（浅层 V1）。
 * 重名工具在启动期即抛 {@link com.agentflow.ability.tool.ToolConflictException}，显式暴露冲突。
 */
